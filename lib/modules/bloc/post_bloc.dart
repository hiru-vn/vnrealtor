...
class PostBloc extends ChangeNotifier {
  ...
  void setLikePostLocal(String? postId, int likeCounter, bool isUserLike) {
    ...
    post = myPosts!.firstWhereOrNull((element) => element.id == postId);
    if (post != null)
      post
        ..like = likeCounter
        ..isUserLike = isUserLike;
    post = stories.firstWhereOrNull((element) => element.id == postId);
    if (post != null)
      post
        ..like = likeCounter
        ..isUserLike = isUserLike;
    post = savePosts.firstWhereOrNull((element) => element.id == postId);
    if (post != null)
      post
        ..like = likeCounter
        ..isUserLike = isUserLike;
