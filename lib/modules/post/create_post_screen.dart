                ...
                child: Row(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child:
                          VerifiedIcon(AuthBloc.instance.userModel?.role, 10),
                    ),
                    SizedBox(width: 10),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Row(
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  AuthBloc.instance.userModel.totalPoint
                                      .toString(),
                                ),
                                Image.asset(
                              ...
                              child: HashTagTextField(
                                ...
                                onChanged: (value) async {
                                  ...
                                  for (var match in matches) {
                                    final data = await getUrlData(value
...
class CreatePostScreenAppBar extends StatelessWidget
    implements PreferredSizeWidget {
  final PageController controller;
  final Function createPost;
  final bool enableBtn;
  Size get preferredSize => Size.fromHeight(kToolbarHeight);
  CreatePostScreenAppBar(this.controller, this.createPost, this.enableBtn);
  @override
  Widget build(BuildContext context) {
    return Container(
